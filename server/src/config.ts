...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'codechallengemarco';
  ...
  'jhipster.mail.from' = 'codechallengemarco@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'codechallengemarco API';
  'jhipster.swagger.description' = 'codechallengemarco API documentation';
  ...
  'eureka.instance.appname' = 'codechallengemarco';
  'eureka.instance.instanceId' = 'codechallengemarco:${random.value}';
  ...
  'cloud.config.name' = 'codechallengemarco';
